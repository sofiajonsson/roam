...
p21=Post.create(title: "Marrakesh Camel Ride", description: "The country's Mediterranean climate is similar to that of southern California, with lush forests in the northern and central mountain ranges of the country, giving way to drier conditions and inland deserts further southeast.", user: u4, location: l21, photo_url: "https://angieaway.com/wp-content/uploads/2013/08/IMG_0744.jpg")
